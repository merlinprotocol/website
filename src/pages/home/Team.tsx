...
import cmoava from '@/assets/cto-ava.png';
import cfa2 from '@/assets/cfa2.png';
import cfa2ava from '@/assets/cfa2-ava.png';
import cfa from '@/assets/cfa.png';
import cfaava from '@/assets/cfa-ava.png';
  ...
  return (
    <div className={styles.team}>
      <div className={styles.block}>
        ...
        <span>
          who is an early participant and contributor to the Bitcoin community, code contributor to the open source project LibBitcoin. developer and technical
          expert with deep roots in the blockchain space and other IT technology sectors. Past experiences include: core developer of a pioneering public
          blockchain project in 2016; P2P network architect and key developer of a Top video streaming provider; Founder and key developer of a distributed
          computing and storage service provider; and contributor of series open-source projects on github.
        </span>
      </div>
      ...
      <div className={styles.block}>
        <img src={cfa2} className={styles.title} />
      ...
      <div className={styles.block}>
        <img src={cfa} className={styles.title} />
        <img src={cfaava} className={styles.avatar} />
        <span>
